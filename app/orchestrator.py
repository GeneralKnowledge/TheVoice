...
class PerformanceOrchestrator:
    ...
    def __init__(self, cfg: AppConfig) -> None:
        ...
        self.tts = build_tts_client(
            cfg.tts_provider,
            cfg.tts_voice,
            cfg.tts_rate,
            collective_base_provider=cfg.tts_collective_base_provider,
            collective_base_gtts_tld=cfg.tts_collective_base_gtts_tld,
            collective_elevenlabs_voice_id=cfg.tts_collective_elevenlabs_voice_id,
            collective_elevenlabs_model_id=cfg.tts_collective_elevenlabs_model_id,
        )
