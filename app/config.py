...
class AppConfig:
    ...
    tts_rate: int = 165
    tts_collective_base_provider: str = "gtts"
    tts_collective_base_gtts_tld: str = "co.uk"
    tts_collective_elevenlabs_voice_id: str | None = None
    tts_collective_elevenlabs_model_id: str = "eleven_multilingual_v2"
...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        tts_collective_base_provider=os.getenv("BOT_TTS_COLLECTIVE_BASE_PROVIDER", "gtts"),
        tts_collective_base_gtts_tld=os.getenv("BOT_TTS_COLLECTIVE_BASE_GTTS_TLD", "co.uk"),
        tts_collective_elevenlabs_voice_id=os.getenv("BOT_TTS_COLLECTIVE_ELEVENLABS_VOICE_ID"),
        tts_collective_elevenlabs_model_id=os.getenv("BOT_TTS_COLLECTIVE_ELEVENLABS_MODEL_ID", "eleven_multilingual_v2"),
